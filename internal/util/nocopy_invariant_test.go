...
var reviewedInPlaceByteWrites = map[string]reviewedInPlaceByteWrite{
	"internal/runtime/executor/codex_fingerprint_convergence.go": {2, "copies a SHA-256 digest and parsed UUID timestamp into a new private UUID array; no GJSON result aliases the destination"},
